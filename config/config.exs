...
config :ts_oban, TsObanWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: TsObanWeb.ErrorHTML, json: TsObanWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: TsOban.PubSub,
  live_view: [signing_salt: "D4Hv5bCQ"]
...
config :ts_oban, TsOban.Mailer, adapter: Swoosh.Adapters.Local
